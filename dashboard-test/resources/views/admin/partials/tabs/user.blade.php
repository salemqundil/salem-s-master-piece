        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.users.banned') ? 'active' : '' }}"
                    ...
                    @if($bannedUsersCount)
                    <span class="badge rounded-pill bg--primary">{{$bannedUsersCount}}</span>
                    @endif
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.users.email.unverified') ? 'active' : '' }}"
                    ...
                    <span class="badge rounded-pill bg--primary">{{$emailUnverifiedUsersCount}}</span>
                    @endif
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::routeIs('admin.users.mobile.unverified') ? 'active' : '' }}"
                    ...
                    <span class="badge rounded-pill bg--primary">{{$mobileUnverifiedUsersCount}}</span>
                    @endif
                </a>
            </li>
            <li class="nav-item">
