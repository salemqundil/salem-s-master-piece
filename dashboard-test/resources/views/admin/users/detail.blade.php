                                ...
                                <div class="card-body">
                                    <div class="row align-items-center m-b-0">
                                        <div class="col">
                                            ...
                                            <h3 class="m-b-0">${{ showAmount($user->balance) }}
                                            </h3>
                                        </div>
                                        <div class="col-auto">
                ...
                <div class="card p-2">
                    <ul class="d-flex flex-wrap gap-1">
                        ...
                        <li class="flex-grow-1 flex-shrink-0">
                            ...
                            @else
                            <a class="userStatus btn bg--primary" data-bs-toggle="modal" data-bs-target="#userStatusModal"
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-text">JD</div>
                        </div>
                    </div>
                    <div class="form-group">
